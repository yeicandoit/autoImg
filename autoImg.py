...
class QnewsAutoImg(AutoImg):
    ...
    def assembleFeedsAd(self):
        blank_height = self.cf.getint('Qnews', 'blank_height')
        ad_width = self.cf.getint('Qnews', 'ad_width')
        ad_height = self.cf.getint('Qnews', 'ad_height')
        ...
        if '' != self.doc:
            ...
            ad_doc_pos = (self.cf.getint('Qnews', 'doc_x'), self.cf.getint('Qnews', 'doc_y'))
    ...
    def start(self):
        ...
        sleep(3)
        blank_height = self.cf.getint('Qnews', 'blank_height')
        if len(self.doc) > self.set1stDocLen(self.doc, 'Qnews'):
