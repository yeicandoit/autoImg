...
class BatteryDoctorAutoImg(Base):
    def __init__(self, time, battery, img_paste_ad, img_corner_mark='ad_area/corner-mark.png', ad_type='banner',
        ...
        if 'banner' == self.ad_type:
            ...
            self.logger.debug("fp_ad_banner_flag:%s, fp_charge", self.fp_ad_banner_flag, self.fp_charge)
    ...
    def bannerStart(self):
        ...
        assert self.findElement4Awhile(self.img_ad_banner_flag, self.fp_ad_banner_flag), "Do not find banner in batterydoctor"
...
if __name__ == '__main__':
    try:
        autoImg = BatteryDoctorAutoImg('11:49', 0.8, 'ads/640x330.jpg', '../ad_area/corner-ad.png',
                               'check', '4G', u'吉利新帝豪', u'饼子还能这么吃，秒杀鸡蛋灌饼，完爆煎饼果子，做法还超级简单！')
